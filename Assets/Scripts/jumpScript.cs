...
public class jumpScript : MonoBehaviour {
	...
	void Update () {
		...
		if (Input.GetKey ("a")) { //Mover a la izquierda
			...
			transform.localScale = new Vector3(-1,1,1); // Esto quiere decir que nos variara la escala a -1, que hace que el muñeco este al reves)
		}
	...
	void mover(int fuerza){
		...
		//   | significa "Y", y || significa "O". Esto lo hacemos para darñe fluidez al pollo, para que al girar no decelere hasta frenar, si no que se de la vuelta directamente.
